...
Formatter = (function(superClass) {
  ...
  Formatter.prototype._init = function() {
    this.editor = this._module;
    this._allowedTags = this.opts.allowedTags || ['br', 'a', 'center', 'img', 'b', 'table','tr','td','tbody','thead','strong', 'i', 'u', 'font', 'p', 'ul', 'ol', 'li', 'blockquote', 'pre', 'code', 'h1', 'h2', 'h3', 'h4', 'hr'];
...
Util = (function(superClass) {
  ...
  Util.prototype.blockNodes = ["div", "center","p", "ul", "ol", "li", "blockquote", "hr", "pre", "h1", "h2", "h3", "h4", "table"];
...
Toolbar = (function(superClass) {
  ...
  Toolbar.prototype._tpl = {
    wrapper: '<div class="simditor-toolbar" style="width:100%"><ul></ul></div>',
...
EraserButton = (function(superClass) {
    extend(EraserButton, superClass);

    function EraserButton() {
      return EraserButton.__super__.constructor.apply(this, arguments);
    }

    EraserButton.prototype.name = 'eraser';

    EraserButton.prototype.icon = 'eraser';

    EraserButton.prototype.shortcut = 'cmd+c';

    EraserButton.prototype.render = function() {
      if (this.editor.util.os.mac) {
        this.title = this.title + ' ( Cmd + c )';
      } else {
        this.title = this.title + ' ( Alt + c )';
        this.shortcut = 'alt+c';
      }
      return EraserButton.__super__.render.call(this);
    };

    EraserButton.prototype.command = function() {
  ...
  Simditor.Toolbar.addButton(EraserButton);
...
StrikethroughButton = (function(superClass) {
  ...
  StrikethroughButton.prototype.shortcut = 'cmd+s';

    StrikethroughButton.prototype.render = function() {
      if (this.editor.util.os.mac) {
        this.title = this.title + ' ( Cmd + u )';
      } else {
        this.title = this.title + ' ( Alt + s )';
        this.shortcut = 'alt+s';
      }
